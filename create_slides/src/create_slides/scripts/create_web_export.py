...
Renders `master-thesis-slides/Slide_Samuele_Maggiori_v4.pptx` (v3 — professor-reviewed
with inverted video start/end — plus the parity-plot and LLM-results slides) into a
