...
Among the configurations tested, the optimal hyperparameters were identified based on the highest Q² score achieved during cross-validation. The best-performing configuration achieved a Q² score of approximately 0.42 using LOOCV evaluation. This result is noteworthy given the extreme data scarcity and the inherent complexity of polymer-molecule interactions. A Q² of 0.42 indicates that the model explains approximately 42\% of the variance in the absorption capacity, capturing a meaningful portion of the underlying relationship while leaving substantial room for improvement.
