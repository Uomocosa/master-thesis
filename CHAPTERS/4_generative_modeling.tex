...
Training was performed on two datasets. The primary training set for polymer generation was the PI1M dataset~\cite{pi1m}, a comprehensive collection of synthetic polymer structures represented in P-SMILES notation. For comparison, a secondary model was trained on the "ZINC\_base" dataset~\cite{zinc15, lim2018cvae} to evaluate the generation of standard molecular SMILES strings.
